...
public enum Zone {
    ...
    ShamrockCliffs("Shamrock Cliffs", "malachite_hills.ogg"),
    ...
    Celewynn("Celewynn", "malachite_hills.ogg"),
    CelenorCaves("Celenor Caves", "malachite_hills.ogg"),
    CelenorForestEdge("Celenor Forest Edge", "malachite_hills.ogg"),
