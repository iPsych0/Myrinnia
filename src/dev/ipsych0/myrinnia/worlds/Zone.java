...
public enum Zone {
    ...
    PortAzure("Port Azure", "port_azure.ogg"), Myrinnia("Myrinnia", "DUMMY"), SunsetCove("Sunset Cove", "sunsetsunrise.wav"),
    ...
    PortAzureInside("Port Azure", "port_azure.ogg"), ShamrockHarbour("Shamrock Harbour", "shamrock.wav"), ShamrockTown("Shamrock Town", "shamrock.wav"),
