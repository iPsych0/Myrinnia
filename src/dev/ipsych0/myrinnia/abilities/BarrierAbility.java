...
public class BarrierAbility extends Ability implements Serializable {

    private Animation animation;
    private boolean boostApplied;

    public BarrierAbility(CharacterStats element, CharacterStats combatStyle, String name, AbilityType abilityType, boolean selectable,
    ...
    public void renderIcon(Graphics2D g, int x, int y) {
        g.drawImage(Assets.barrierI, x, y, null);
    }
