...
public class BulkUpAbility extends Ability implements Serializable {

    private Animation animation;
    private boolean boostApplied;

    public BulkUpAbility(CharacterStats element, CharacterStats combatStyle, String name, AbilityType abilityType, boolean selectable,
    ...
    public void renderIcon(Graphics2D g, int x, int y) {
        g.drawImage(Assets.bulkUpI, x, y, null);
    }
