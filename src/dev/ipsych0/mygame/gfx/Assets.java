...
public class Assets {
	...
	public static void init(){
		...
		SpriteSheet swordSprites = new SpriteSheet("/textures/swordsprites.png");
		/*
		 ...
		 * Remove this one
		 */
		SpriteSheet swamp_land = new SpriteSheet("/textures/swampland.png");
		/*
		 * Change this one
		 */
		...
		SpriteSheet test_sheet = new SpriteSheet("/textures/empty_sprite_sheet.png");
...
//		earringSlot, mainhandSlot, glovesSlot, ringSlot1, helmSlot, bodySlot, legsSlot, bootsSlot, amuletSlot, offhandSlot, capeSlot, ringSlot2;
		...
		// Minimap images
		swampLand = swamp_land.tileCrop(0, 0, 800, 800);
		...
		testSword = test_sheet.tileCrop(width * 0, height * 0, width, height);
		purpleSword = swordSprites.tileCrop(width, height * 0, width, height);
