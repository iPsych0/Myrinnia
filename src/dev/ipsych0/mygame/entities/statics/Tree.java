...
public class Tree extends StaticEntity {
	...
	@Override
	public void die(){
		handler.getPlayer().getChatWindow().sendMessage("You chopped the tree.");
		handler.getWorld().getItemManager().addItem(Item.woodItem.createNew((int) x + 4, (int) y + 6, handler.getRandomNumber(1, 3)));
