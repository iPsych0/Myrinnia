...
public class GoblinoArcher extends Creature {
    ...
    public GoblinoArcher(double x, double y, int width, int height, String name, int level, String dropTable, String jsonFile, String animation, String itemsShop, Direction direction) {
    ...
    protected void checkAttacks() {
        ...
        new Projectile.Builder(DamageType.DEX, Assets.regularArrow, this, (int) Handler.get().getPlayer().getX(), (int) Handler.get().getPlayer().getY())
                .withVelocity(8.0f)
                .build();
    ...
    @Override
    public void respawn() {
        Handler.get().getWorld().getEntityManager().addEntity(new GoblinoArcher(xSpawn, ySpawn, width, height, name, combatLevel, dropTable, jsonFile, animationTag, shopItemsFile, direction));
    }
