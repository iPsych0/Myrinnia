...
public class ForgottenGhost extends Entity {
    ...
    public ForgottenGhost(, Direction direction) {
    ...
    @Override
    public void respawn() {
        Handler.get().getWorld().getEntityManager().addEntity(new ForgottenGhost(xSpawn, ySpawn, width, height, name, combatLevel, dropTable, jsonFile, animationTag, itemsShop, direction));
    }
