...
public class AzureScorpion extends Entity {
...
//		ar.height = arSize;
    ...
    @Override
    public void respawn() {
        Handler.get().getWorld().getEntityManager().addEntity(new AzureScorpion(xSpawn, ySpawn, width, height, name, combatLevel, dropTable, jsonFile, animationTag, itemsShop, direction));
    }
