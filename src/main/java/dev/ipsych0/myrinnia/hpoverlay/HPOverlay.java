...
public class HPOverlay implements Serializable {
    ...
    private UIImageButton skillsButton, characterButton, abilitiesButton, questsButton, mapButton, helpButton;
    ...
    public HPOverlay() {
        ...
        // Bars
        hpBar = new Rectangle(56, 38, 176, 24);
        xpBar = new Rectangle(56, 64, 176, 24);

        bounds = new Rectangle(8, 8, 240, 128);

        combatBar = new Rectangle(8, 10, 208, 32);

        // Buttons
        questsButton = new UIImageButton(bounds.x + bounds.width / 2 - 96, bounds.y + bounds.height - 40, 32, 32, Assets.genericButton);
        skillsButton = new UIImageButton(bounds.x + bounds.width / 2 - 64, bounds.y + bounds.height - 40, 32, 32, Assets.genericButton);
        characterButton = new UIImageButton(bounds.x + bounds.width / 2 - 32, bounds.y + bounds.height - 40, 32, 32, Assets.genericButton);
        abilitiesButton = new UIImageButton(bounds.x + bounds.width / 2, bounds.y + bounds.height - 40, 32, 32, Assets.genericButton);
        mapButton = new UIImageButton(bounds.x + bounds.width / 2 + 32, bounds.y + bounds.height - 40, 32, 32, Assets.genericButton);
        helpButton = new UIImageButton(bounds.x + bounds.width / 2 + 64, bounds.y + bounds.height - 40, 32, 32, Assets.genericButton);
        ...
        uiManager.addObject(helpButton);
    ...
    public void render(Graphics2D g) {
        if (isOpen) {
            ...
            g.drawImage(Assets.undiscovered, helpButton.x, helpButton.y, 32, 32, null);
            ...
            Text.drawString(g, "Combat level: " + Handler.get().getSkillsUI().getSkill(SkillsList.COMBAT).getLevel(),
                    bounds.x + bounds.width / 2, combatBar.y + combatBar.height / 2, true, Color.YELLOW, Assets.font14);
            ...
            if (questsButton.contains(mouse)) {
                ...
                g.drawImage(Assets.genericButton[1], mouse.x + 8, mouse.y + 8, 96, 32, null);
                Text.drawString(g, "Tips (;)", mouse.x + 56, mouse.y + 24, true, Color.YELLOW, Assets.font14);
            }
